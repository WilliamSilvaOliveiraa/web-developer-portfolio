...
import eurogrill from "../imgs/Ladingpage.png";
import m_eurogrill from "../imgs/m_simple_landing_page.png";
    ...
    <div class="projeto-main">
      <div className="project-page">
        <div className="project-top">
          <div className="project-logo">
            ...
            <h2 className="landing-logo">
              Simples Landing Page Principal Completa Para Exposições
            </h2>
          </div>
        ...
        <div className="project-buttons">
          <a
            href="https://simple-landing-page-mocha.vercel.app/"
            target="_blank"
          ...
          <a
            href="https://github.com/WilliamSilvaOliveiraa/simple-landing-page"
            target="_blank"
